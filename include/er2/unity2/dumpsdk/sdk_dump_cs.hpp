...

{
...

    {
        ...
        // Properties - derive from getter/setter methods

        if (td->methodCount > 0)

        {

            // Collect properties by scanning methods for get_* and set_* patterns

            std::vector<std::tuple<std::string, std::string, bool, bool>> props; // name, type, hasGet, hasSet
