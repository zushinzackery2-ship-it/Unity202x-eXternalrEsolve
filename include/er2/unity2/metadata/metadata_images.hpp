...
#include "header/metadata_header_fields.hpp"
...

{
...

    {
        ...
        (void)er2::ReadCStringFromMetadataStrings(mem, metaBase, h, nameIndex, info.name);
...

{
...

    {
        ...
        (void)er2::ReadCStringFromMetadataStringsBytes(meta, h, nameIndex, info.name);
