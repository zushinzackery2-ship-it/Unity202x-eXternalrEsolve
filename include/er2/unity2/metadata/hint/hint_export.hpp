...
#include "../codegen/codegen_modules.hpp"

#include "../header/header_parser.hpp"

#include "hint_json.hpp"

#include "../pe.hpp"

#include "../registration/registration_scanner.hpp"

#include "../registration/scanner_pointer.hpp"
...

{
    ...
    if (outHint.moduleBase && outHint.moduleSize)

    {
        ...
        if (FindIl2CppRegistrations(
                ...
                outHint.modulePath.empty() ? std::filesystem::path() : std::filesystem::path(outHint.modulePath),
